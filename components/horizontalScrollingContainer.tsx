...
export default function HorizontalScrollComponent({
  ...
  title,
  CardComponent,
}: HorizontalScrollComponentProps) {
  ...
  return (
    <div className="relative">
      <div ref={containerRef} className="min-h-screen">
        <h1
          ref={titleRef}
          className="fixed top-[15vh] left-[3%] text-4xl font-bold"
        >
          {title}
        </h1>

        <div className="flex min-h-[110vh] items-end">
        ...
        >
          <div
            ref={buttonRef}
            className="z-6 w-1/4 max-w-[300px] translate-y-12 transform opacity-0"
          >
            <LinkButton
