...
export const me: Me = {
    ...
    status: "available",
    description: [
        <React.Fragment key="p1">Je suis un jeune développeur très curieux</React.Fragment>,
        <React.Fragment key="p2">J&apos;adore intégrer de beaux designs</React.Fragment>,
        <React.Fragment key="p3">Mais aussi travailler sur des APIs</React.Fragment>,
        <React.Fragment key="p4">J&apos;aime travailler sur des projets captivants</React.Fragment>,
        ...
        <div key="p6" className="time text-center w-full">Des projets où je sens que mon temps sert à quelque chose</div>,
        <div key="p7" className="smiles text-center w-full">J&apos;aime travailler avec de belles personnes</div>,
        <React.Fragment key="p8">Mais j&apos;apprécie aussi travailler <AloneText>seul</AloneText></React.Fragment>,
        <React.Fragment key="p9">J&apos;aime les personnes <strong className="peaceful">calmes</strong> et <strong className="peaceful">discrètes</strong></React.Fragment>,
        <div key="p10" className="energyText text-center w-full">Mais aussi <EnergyText>amusantes</EnergyText> et <EnergyText>énergiques</EnergyText></div>,
        <React.Fragment key="p11">J&apos;aime rester chez moi ⌂</React.Fragment>,
        <React.Fragment key="p12">Mais j&apos;ai aussi envie de voir <OutsideText>l&apos;extérieur</OutsideText></React.Fragment>,
        <React.Fragment key="p13">J&apos;aime les <ColoredText>couleurs</ColoredText></React.Fragment>,
        <React.Fragment key="p14">Mais aussi le <RotatingText variant="whiteBackground">noir</RotatingText> et le <RotatingText variant="blackBackground">blanc</RotatingText></React.Fragment>
    ],
    images: [
        {
            "id": 9,
